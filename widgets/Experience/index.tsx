  ...
  const experienceList = [
    {
      ...
      comments: [
        "Built fullstack Back-office applications in React/NextJS and Node JS that is used to managing users, tasks, and daily activities for digital banks which has improved banking efficiency and better work structure.",
        "Built fullstack CRM tools for digital banks, which is used in improving the organization and resolution of customer issues by customer care representatives.",
        ...
        "Built digital bank portfolio platforms that showcase core business values and attract new users",
